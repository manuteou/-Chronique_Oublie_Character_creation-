...
intelligence = interface.intelligence.get()
...
if race_choix == 1:
    ...
    joueur.caracteristiques(force, dexterité, constitution-2, intelligence ,sagesse+2, charisme)
elif race_choix == 2:
    joueur = Personnages.Demi_Orques(nom_joueur, nom_personnage, genre, 80, 40, 15, 50, 1.7, 2.1)
    joueur.caracteristiques(force+2, dexterité, constitution, intelligence-2, sagesse, charisme-2)
elif race_choix == 3:
    joueur = Personnages.Elfes_Hauts(nom_joueur, nom_personnage, genre, 70, 40, 80, 400, 1.5, 1.8)
    joueur.caracteristiques(force-2, dexterité, constitution, intelligence, sagesse, charisme+2)
elif race_choix == 4:
    ...
    joueur.caracteristiques(force-2, dexterité, constitution, intelligence+2, sagesse, charisme)
elif race_choix == 6:
    joueur = Personnages.Halfelins(nom_joueur, nom_personnage, genre, 30, 20, 20, 100, .8, 1)
    joueur.caracteristiques(force-2, dexterité+2, constitution, intelligence, sagesse, charisme)
elif race_choix == 7:
    joueur = Personnages.Humains(nom_joueur, nom_personnage, genre, 120, 40, 18, 100, 1.5, 2)
    joueur.caracteristiques(force, dexterité, constitution, intelligence, sagesse, charisme)
elif race_choix == 8:
    joueur = Personnages.Nains(nom_joueur, nom_personnage, genre, 100, 50, 40, 200, 1.15, 1.35)
    joueur.caracteristiques(force, dexterité-2, constitution+2, intelligence, sagesse, charisme)
